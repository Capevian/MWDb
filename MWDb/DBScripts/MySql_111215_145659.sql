...
-- Tipo_Modelo [rel3]
alter table `modelo`  add column  `tipo_oid`  integer;
alter table `modelo`   add index fk_modelo_tipo (`tipo_oid`), add constraint fk_modelo_tipo foreign key (`tipo_oid`) references `tipo` (`oid`);
