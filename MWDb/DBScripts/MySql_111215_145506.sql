...
alter table `avaliacao`   add index fk_user_avaliacao (`miniatura_oid_mini`, `user_oid_user`), add constraint fk_user_avaliacao foreign key (`miniatura_oid_mini`, `user_oid_user`) references `avaliacao` (`miniaturaoidmini`, `useroiduser`);
...
alter table `avaliacao`   add index fk_miniatura_avaliacao (`miniatura_oid_mini`, `user_oid_user`), add constraint fk_miniatura_avaliacao foreign key (`miniatura_oid_mini`, `user_oid_user`) references `avaliacao` (`miniaturaoidmini`, `useroiduser`);
